...
@SessionAttributes("clientTransactionSearchForm")
public class ClientTransactionSearchController {
	private final String transactionsSearch = "transactions/search";
	
	@Autowired
	private ClientTransactionSearchService clientTransactionSearchService;
	
	@RequestMapping(method = RequestMethod.GET)
	public String init(ClientTransactionSearchForm clientTransactionSearchForm, ModelMap modelMap) {
		clientTransactionSearchService.init(clientTransactionSearchForm, modelMap);
...
//	}
	...
	@ExceptionHandler(ClientTransactionSearchException.class)
	public ModelAndView handle(ClientTransactionSearchException exception, HttpServletRequest request) {
